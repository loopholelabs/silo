...
func shutdownEverything(log types.RootLogger) {
...
func setupStorageDevice(conf *config.DeviceSchema, log types.RootLogger, met *metrics.Metrics) (*storageInfo, error) {
...
// Migrate a device
func migrateDevice(log types.RootLogger, met *metrics.Metrics, devID uint32, name string,
