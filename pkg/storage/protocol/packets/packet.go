...
const (
	...
	COMMAND_HASHES            = COMMAND_REQUEST | byte(8)
	COMMAND_WRITE_AT_WITH_MAP = COMMAND_REQUEST | byte(9)
	COMMAND_REMOVE_DEV        = COMMAND_REQUEST | byte(10)
	COMMAND_REMOVE_FROM_MAP   = COMMAND_REQUEST | byte(11)
	COMMAND_ALTERNATE_SOURCES = COMMAND_REQUEST | byte(12)
)
