...
const COMMAND_DONT_NEED_AT = COMMAND_REQUEST | byte(4)
const COMMAND_DIRTY_LIST = COMMAND_REQUEST | byte(5)
const COMMAND_DEV_INFO = COMMAND_REQUEST | byte(6)
const COMMAND_EVENT = COMMAND_REQUEST | byte(7)
...
const COMMAND_EVENT_RESPONSE = COMMAND_RESPONSE | byte(5)
